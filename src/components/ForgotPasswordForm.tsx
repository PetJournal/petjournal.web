  ...
  return (
    ...
    >
      <label className="flex flex-col gap-2">
        <span className="mb-1 block text-custom-purple font-medium">
          Qual o seu e-mail de cadastro?
        </span>
        <div>
      ...
      <div className="flex flex-col gap-2">
        ...
        items-center justify-center rounded-[16px] mt-16 ${
          isButtonDisabled
        ...
        <button
          ...
          className={`w-[154px] h-[48px] flex self-center font-medium 
            items-center justify-center rounded-[16px] 'bg-transparent border-2 
